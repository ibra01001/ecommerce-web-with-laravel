...
@if($footer)
<footer style="background: color-mix(in srgb, var(--background-color)); color: color-mix(in srgb, var(--text-color) 40%, transparent);">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        @foreach($footer?->getActiveSocialMediaLinks() as $platform => $link)
                            <a href="{{ $link['url'] }}" target="_blank" rel="noopener noreferrer"
                               ...
                               onmouseout="this.style.background='color-mix(in srgb, var(--primary-color) 85%, transparent)'; this.style.color='color-mix(in srgb, var(--text-color) 70%, transparent)'"
                               title="{{ $link['name'] }}">
            ...
            <!-- Quick Links -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold" style="color: var(--text-color);">Quick Links</h3>
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('home') }}" 
                           ...
                           onmouseout="this.style.color='color-mix(in srgb, var(--text-color) 70%, transparent)'">Home</a>
                    </li>
                    <li>
                        <a href="{{ route('products.index') }}" 
                           ...
                           style="color: color-mix(in srgb, var(--text-color) 70%, transparent);"
                           onmouseover="this.style.color='var(--primary-color)'"
                           onmouseout="this.style.color='color-mix(in srgb, var(--text-color) 70%, transparent)'">Products</a>
                    </li>
                    <li>
                        <a href="{{ route('about-us') }}" 
                           ...
                           style="color: color-mix(in srgb, var(--text-color) 70%, transparent);"
                           onmouseover="this.style.color='var(--primary-color)'"
                           onmouseout="this.style.color='color-mix(in srgb, var(--text-color) 70%, transparent)'">About Us</a>
                    </li>
                    <li>
                        <a href="{{ route('cart.index') }}" 
                           ...
                           style="color: color-mix(in srgb, var(--text-color) 70%, transparent);"
                           onmouseover="this.style.color='var(--primary-color)'"
                           onmouseout="this.style.color='color-mix(in srgb, var(--text-color) 70%, transparent)'">Shopping Cart</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <form action="{{ route('newsletter.subscribe') }}" method="POST" class="space-y-3">
                        ...
                        <input type="email" name="email" placeholder="Your email address"
                               class="w-full  px-4 py-2.5 text-sm border transition-colors duration-300"
                               style="background: color-mix(in srgb, var(--background-color) 85%, transparent); border-color: color-mix(in srgb, var(--text-color) 70%, transparent); color: var(--text-color);"
                               onfocus="this.style.borderColor='var(--primary-color)'"
                               onblur="this.style.borderColor='color-mix(in srgb, var(--text-color) 70%, transparent)'"
                               required>
                        <button type="submit"
                                class="w-full px-4 py-2.5  font-medium text-sm transition-all duration-300"
                                style="background: var(--primary-color); color: var(--background-color);"
        ...
        <!-- Bottom Bar -->
        <div class="pt-8 mt-8" style="border-top: 1px solid color-mix(in srgb, var(--text-color) 80%, transparent);">
                ...
                <div class="flex items-center gap-6">
                    @if($footer?->terms_url)
                        <a href="{{ $footer?->terms_url }}" 
                           ...
                           onmouseover="this.style.color='var(--primary-color)'"
                           onmouseout="this.style.color='color-mix(in srgb, var(--primary-color) 70%, transparent)'">
                            Terms & Conditions
                        </a>
                    @endif
