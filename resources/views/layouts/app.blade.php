...
<body class="antialiased">
    ...
    <nav class="fixed top-0 w-full z-50 navbar-glass">
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-12">
                    ...
                    <button id="theme-toggle-btn" 
                        ...
                        <svg id="sun-icon" class="w-5 h-5 transition-all duration-500 {{ $currentMode === 'light' ? '' : 'hidden' }}" 
                        ...
                        <svg id="moon-icon" class="w-5 h-5 transition-all duration-500 {{ $currentMode === 'dark' ? '' : 'hidden' }}" 
                             style="color: var(--primary-color);" 
                             fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                        ...
                        <!-- Loading Spinner -->
                        <svg id="loading-icon" class="w-5 h-5 hidden animate-spin" 
                             style="color: var(--primary-color);" 
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="mobile-menu md:hidden fixed top-20 right-0 h-[calc(100vh-5rem)] w-64 shadow-2xl z-40"
            ...
            <div class="flex flex-col p-6 space-y-6">
                ...
                <div class="pt-4 border-t" style="border-color: color-mix(in srgb, var(--text-color) 10%, transparent);">
                    <button id="mobile-theme-toggle" 
                        ...
                        <div class="flex items-center gap-3">
                            <div class="p-2 rounded-lg" style="background: color-mix(in srgb, var(--primary-color) 20%, transparent);">
                                <svg id="mobile-sun-icon" class="w-5 h-5 transition-all duration-500 {{ $currentMode === 'light' ? '' : 'hidden' }}" 
                                     style="color: var(--primary-color);" 
                                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                          d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
                                </svg>
                                <svg id="mobile-moon-icon" class="w-5 h-5 transition-all duration-500 {{ $currentMode === 'dark' ? '' : 'hidden' }}" 
                                     style="color: var(--primary-color);" 
                                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                          d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" />
                            ...
                            <div class="text-left">
                                ...
                                <div class="text-xs" style="color: color-mix(in srgb, var(--text-color) 60%, transparent);">
