...
<body>
    ...
    <aside class="sidebar p-6 shadow-sm">
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('admin.newsletter.index') }}" class="{{ request()->is('admin/newsletter*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <a href="{{ route('admin.stock-types.index') }}" class="{{ request()->is('admin/stock-types*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <a href="{{ route('admin.appearance.settings') }}" class="{{ request()->is('admin/appearance*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <a href="{{ route('admin.hero-home.edit') }}" class="{{ request()->is('admin/hero-home*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <a href="{{ route('admin.features.edit') }}" class="{{ request()->is('admin/features*') || request()->is('admin/brand-story*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 0 2.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 0 0 2.25 2.25h13.5M6 7.5h3v3H6v-3Z" />
            ...
            <a href="{{ route('admin.footer.edit') }}" class="{{ request()->is('admin/footer*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M3 16.5V6a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 6v10.5M3 16.5h18M12 12l-3-3m0 0l3-3m-3 3h12.75" />
                </svg>
                Footer
            </a>
        </nav>
    ...
    <main class="main-content p-6 lg:p-12 min-h-screen">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 lg:mb-10">
            ...
            <a href="/" class="transition-colors duration-300 font-medium text-sm flex items-center gap-2" style="color: color-mix(in srgb, var(--text-color) 60%, transparent);" onmouseover="this.style.color='var(--primary-color)'" onmouseout="this.style.color='color-mix(in srgb, var(--text-color) 60%, transparent)'">
