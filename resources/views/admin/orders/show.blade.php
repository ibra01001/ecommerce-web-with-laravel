            ...
            <div>
                ...
                <div class="space-y-2 text-gray-300">
                    <p><x-heroicon-o-identification class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Name:</span> {{ $order->first_name }} {{ $order->last_name }}
                    </p>
                    <p><x-heroicon-o-phone class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Phone:</span> {{ $order->phone }}
                    </p>
                    <p><x-heroicon-o-envelope class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Email:</span> {{ $order->email ?? '—' }}
                    </p>
                    <p><x-heroicon-o-map-pin class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Address:</span> {{ $order->address }}
                    </p>
                    <p><x-heroicon-o-map class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Wilaya:</span> {{ $order->wilaya }}
                    </p>
                    <p><x-heroicon-o-building-office class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Commune:</span> {{ $order->commune }}
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-2 text-gray-300">
                    <p><x-heroicon-o-currency-dollar class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Subtotal:</span> {{ number_format($order->subtotal, 2) }} DA
                    </p>
                    <p><x-heroicon-o-currency-dollar class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Total:</span> {{ number_format($order->total, 2) }} DA
                    </p>
                    <p><x-heroicon-o-truck class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Shipping Cost:</span>
                        {{ number_format($order->shipping_cost, 2) }} DA
                    </p>
                    <p><x-heroicon-o-calendar class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Date:</span> {{ $order->created_at->format('M d, Y H:i') }}
                    </p>

                    <p><x-heroicon-o-document-text class="inline w-5 h-5 text-yellow-400 mr-2" />
                        <span class="font-medium text-white">Notes:</span> {{ $order->notes ?: 'No additional notes' }}
                    </p>
