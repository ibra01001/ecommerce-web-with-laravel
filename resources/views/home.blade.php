...
@section('content')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                @forelse($featuredProducts as $product)
                    <a href="{{ route('products.show', $product->id) }}" 
                       class="group block fade-in product-card">
                        <div class="h-full">
                            ...
                            <div class="relative overflow-hidden  mb-4 border-2 border-transparent transition-all duration-300"
                                ...
                                <div class="absolute top-3 left-3 flex flex-col gap-2">
                                    ...
                                    @if(!$product->isInStock())
                                        <span class="px-3 py-1 bg-red-600 text-white text-xs font-medium uppercase tracking-wider  backdrop-blur-sm">
                                            Sold Out
                                        </span>
                                ...
                                <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                                     style="background: linear-gradient(to top, color-mix(in srgb, var(--primary-color) 20%, transparent), transparent);"></div>
                            </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <!-- Name -->
                                <h3 class="text-lg font-medium text-theme-text group-hover:text-theme-primary transition-colors">
                                    {{ $product->name }}
                                </h3>
    ...
    <style>
        ...
        .product-card:nth-child(1) { --stagger: 1; }
        .product-card:nth-child(2) { --stagger: 2; }
        .product-card:nth-child(3) { --stagger: 3; }
        .product-card:nth-child(4) { --stagger: 4; }
        .product-card:nth-child(5) { --stagger: 5; }
        .product-card:nth-child(6) { --stagger: 6; }
        .product-card:nth-child(7) { --stagger: 7; }
        .product-card:nth-child(8) { --stagger: 8; }
